...
def main(_argv):
  ...
  tf.logging.info("Start - Logging all possible values of tf.trainable_variables()...")
  for var in tf.trainable_variables():
    tf.logging.info(var.name, "Start")
    tf.logging.info(var)
    tf.logging.info(var.name, "End")
    #tf.logging.info(var.name, var)
  tf.logging.info("End - Logging all possible values of tf.trainable_variables()...")
